...
const HeroSection = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <img src="https://media.istockphoto.com/id/1342043587/photo/shot-of-a-car-salesman-handing-over-keys-to-a-customer.jpg?s=612x612&w=0&k=20&c=9Ei9MQ7Rj0aJm-0DpNkQbD_YwPszjnwcsd9k1UE94R4=" className=" rounded-lg shadow-2xl" alt='' />
    <div>
